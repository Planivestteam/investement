"""
Serviço de Inteligência Artificial (Claude / Anthropic).
...
def _call(system: str, user_content: str, max_tokens: int = 1500) -> str:
    client = get_client()
...
""" % DISCLAIMER
    ...
    raw = _call(system, json.dumps(context, ensure_ascii=False, default=str))
...
"""
    ...
    raw = _call(system, payload, max_tokens=2000)
