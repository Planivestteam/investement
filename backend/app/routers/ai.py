...
from ..services import yahoo, scoring, gemini
...
def analyze(ticker: str):
    try:
        ...
        analysis = gemini.analyze_asset(ticker, quote, info, history_summary, news, score)
...
def compare(tickers: list[str]):
    ...
    try:
        ...
        resposta = gemini.compare_assets(contexto)
